package HVE.monash.crypto.hve;

import HVE.monash.crypto.hve.core.impl.SHVEPredicateEngine;
import HVE.monash.crypto.hve.generator.impl.SHVEMasterSecretKeyGenerator;
import HVE.monash.crypto.hve.generator.impl.SHVEParameterGenerator;
import HVE.monash.crypto.hve.generator.impl.SHVESecretKeyGenerator;
import HVE.monash.crypto.hve.param.KeyParameter;
import HVE.monash.crypto.hve.param.impl.*;
...
//        int[][] vectors = {{1,1,-1,-1,1},{1,1,0,0,1}};
